    ...
    <div className="bg-gradient-to-b from-gray-100 to-gray-200 flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          >
            <h2 className="text-2xl font-semibold text-navy-900 font- mb-6 text-gray-600">
              Send a Message
            </h2>
            {isSubmitted && (
              <motion.div
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="text-gray-600">
                  <label
                    htmlFor="name"
                    className="block text-sm font-medium text-navy-900 font-roboto"
                  >
                    Full Name
                  </label>
                  <input
                    ...
                    } shadow-sm focus:border-gold-600 focus:ring-gold-600 sm:text-sm py-2.5 px-4 transition-all duration-200 ease-in-out font-roboto text-navy-900`}
                  ...
                  {errors.name && (
                    <p
                      id="name-error"
                      className="mt-1 text-sm text-red-600 font-roboto"
                    >
                      {errors.name}
                    </p>
                  )}
          ...
          >
            ...
            <div className="space-y-6 text-gray-600">
              <div>
                <h3 className="text-lg font-medium text-navy-900 font-roboto">
                  Global Headquarters
                </h3>
      ...
      <div>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d195027.1706424054!2d90.25487367081583!3d23.781067238446077!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka!5e1!3m2!1sen!2sbd!4v1751673331317!5m2!1sen!2sbd"
          width="100%"
          height="500"
          allowfullscreen=""
          loading="lazy"
