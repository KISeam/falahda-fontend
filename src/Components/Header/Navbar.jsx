...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 w-[70%]  shadow-lg z-40 transform transition-all duration-300 ease-in-out ${isMobileMenuOpen
              ...
              {navLinks.map(({ to, label }) => (
                <li key={to}>
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `block px-4 py-3 rounded-lg transition-all duration-300 text-lg poppins ${isActive
